...
def main():
    ...
    prediction_dir = 'output/' #os.path.join(os.getcwd(), 'test_data', model_name + '_results' + os.sep)
    ...
    img_mask = cv2.imread('output/image_mask.png')
    ...
    image.save('input/segmented/transparent.png')